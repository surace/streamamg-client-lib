...
{
	const DROPBOX = "dropboxDistribution.DROPBOX";
	const DROPBOX_SCHEDULED = "dropboxDistribution.DROPBOX_SCHEDULED";
	const FTP = "ftpDistribution.FTP";
	const FTP_SCHEDULED = "ftpDistribution.FTP_SCHEDULED";
	const IDETIC = "ideticDistribution.IDETIC";
	const META = "metaDistribution.META";
	const TVINCI = "tvinciDistribution.TVINCI";
	const VIMEO = "vimeoDistribution.VIMEO";
