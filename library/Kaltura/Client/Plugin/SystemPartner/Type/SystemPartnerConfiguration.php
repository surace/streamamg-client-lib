...
class SystemPartnerConfiguration extends \Kaltura\Client\ObjectBase
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		$this->numberOfSlices = (string)$xml->numberOfSlices;
		$this->sliceWidth = (string)$xml->sliceWidth;
		$this->sliceHeight = (string)$xml->sliceHeight;
	}
	/**
	 * 
	 * @var int
	 ...
	 * @var string
	 */
	public $sliceWidth = null;

	/**
	 * 
	 * @var string
	 */
	public $sliceHeight = null;
