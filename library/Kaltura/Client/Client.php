...
class Client extends Base
{
    ...
    /**
     * @var \Kaltura\Client\Service\SliceAssetService
     */
    protected $sliceAsset = null;
	/**
    ...
    /**
     * @var \Kaltura\Client\Plugin\SystemPartner\Service\SystemPartnerService
     */
    protected $systemPartnerService = null;
	/**
    ...
    /**
     * @return \Kaltura\Client\Service\SliceAssetService
     */
    public function getSliceAssetService()
    {
        if (is_null($this->sliceAsset))
            $this->sliceAsset = new \Kaltura\Client\Service\SliceAssetService($this);
        return $this->sliceAsset;
    }
	...
	/**
     * @retrun Kaltura\Client\Plugin\SystemPartner\Service\SystemPartnerService
     */
    public function getSystemPartnerService()
    {
        if (is_null($this->xInternal))
            $this->systemPartnerService = new \Kaltura\Client\Plugin\SystemPartner\Service\SystemPartnerService($this);
